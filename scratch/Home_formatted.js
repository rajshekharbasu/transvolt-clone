import {
  a9 as reactExports,
  a4 as jsxRuntimeExports,
  D as Dropdown,
  b as DropdownItem,
  ab as requireReact,
  P as PageMeta,
} from "./index-CY0PCP32.js";
import { h } from "./react-apexcharts.esm-Be82zlX2.js";
import { f as flatpickr, S as SvgCalenderLine } from "./index-k2j4P_js.js";
import "./index-BVowYwbD.js";
const SvgMoredot = (I) =>
  ...
  metrics = [
    ...
    },
    {
      ...
      trend: "success",
      borderClass:
        "border-b border-gray-200 xl:border-r xl:border-b-0 dark:border-gray-800",
    },
    {
      label: "Projects",
      value: "15",
  ...
  return jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      ...
      jsxRuntimeExports.jsx("div", {
        ...
        children: metrics.map((I) =>
          jsxRuntimeExports.jsxs(
            "div",
            {
              className: `px-6 py-5 ${I.borderClass}`,
              children: [
                ...
                jsxRuntimeExports.jsxs("div", {
                  ...
                  children: [
                    jsxRuntimeExports.jsx("h4", {
                      className:
                        "text-title-xs sm:text-title-sm font-bold text-gray-800 dark:text-white/90",
                      children: I.value,
                    }),
                    jsxRuntimeExports.jsx("span", {
                      className: `flex items-center gap-1 rounded-full py-0.5 pr-2.5 pl-2 text-sm font-medium ${I.trend === "success" ? "bg-success-50 text-success-600 dark:bg-success-500/15 dark:text-success-500" : "bg-error-50 text-error-600 dark:bg-error-500/15 dark:text-error-500"}`,
                      children: I.change,
                    }),
                  ],
                }),
...
function MonthlySalesChart() {
  const I = {
      ...
      plotOptions: {
        bar: { horizontal: !1, columnWidth: "39%", borderRadius: 5 },
      },
      ...
      yaxis: { title: { text: "" } },
      grid: { yaxis: { lines: { show: !0 } } },
      fill: { opacity: 1 },
      tooltip: { x: { show: !1 }, y: { formatter: (xe) => `${xe}` } },
    },
    w = [
      {
        name: "Sales",
    ...
    [H, V] = reactExports.useState(!1),
    me = () => V(!H),
    Q = () => V(!1);
  return jsxRuntimeExports.jsxs("div", {
    className:
      "overflow-hidden rounded-2xl border border-gray-200 bg-white px-5 pt-5 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6 sm:pt-6",
    children: [
      jsxRuntimeExports.jsxs("div", {
          ...
          jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              jsxRuntimeExports.jsx("button", {
                onClick: me,
                children: jsxRuntimeExports.jsx(SvgMoredot, {
                  className:
                    "text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 size-6",
                }),
              }),
              jsxRuntimeExports.jsxs(Dropdown, {
                isOpen: H,
                onClose: Q,
                className: "w-40 p-2",
                children: [
                  jsxRuntimeExports.jsx(DropdownItem, {
                    onItemClick: Q,
                    children: "View More",
                  }),
                  jsxRuntimeExports.jsx(DropdownItem, {
...
const ChartTab = () => {
  const [I, w] = reactExports.useState("optionOne"),
    H = (V) =>
      I === V
  ...
  return jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      jsxRuntimeExports.jsx("button", {
        onClick: () => w("optionOne"),
        className: `px-3 py-2 font-medium w-full rounded-md text-theme-sm hover:text-gray-900   dark:hover:text-white ${H("optionOne")}`,
        children: "Monthly",
      }),
      jsxRuntimeExports.jsx("button", {
        onClick: () => w("optionTwo"),
        className: `px-3 py-2 font-medium w-full rounded-md text-theme-sm hover:text-gray-900   dark:hover:text-white ${H("optionTwo")}`,
        children: "Quarterly",
      }),
      jsxRuntimeExports.jsx("button", {
        onClick: () => w("optionThree"),
        className: `px-3 py-2 font-medium w-full rounded-md text-theme-sm hover:text-gray-900   dark:hover:text-white ${H("optionThree")}`,
        children: "Annually",
      }),
    ],
  });
...
function StatisticsChart() {
  ...
  reactExports.useEffect(() => {
    ...
    const V = new Date(),
      me = new Date();
    me.setDate(V.getDate() - 6);
    const Q = flatpickr(I.current, {
      mode: "range",
      static: !0,
  ...
  const w = {
      ...
      grid: { xaxis: { lines: { show: !1 } }, yaxis: { lines: { show: !0 } } },
      dataLabels: { enabled: !1 },
      tooltip: { enabled: !0, x: { format: "dd MMM yyyy" } },
      xaxis: {
        type: "category",
        categories: [
          "Jan",
      ...
      jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              ...
              jsxRuntimeExports.jsx("p", {
                className:
                  "mt-1 text-gray-500 text-theme-sm dark:text-gray-400",
          ...
          jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              jsxRuntimeExports.jsx(ChartTab, {}),
              jsxRuntimeExports.jsxs("div", {
                className: "relative inline-flex items-center",
                children: [
                  jsxRuntimeExports.jsx(SvgCalenderLine, {
                    className:
                      "absolute left-3 top-1/2 -translate-y-1/2 size-5 text-gray-500 pointer-events-none",
                  }),
                  jsxRuntimeExports.jsx("input", {
                    ref: I,
                    className:
                      "h-10 w-40 pl-10 pr-3 py-2 rounded-lg border border-gray-200 bg-white text-sm text-gray-700 outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 cursor-pointer",
...
function MonthlyTarget() {
  ...
  return jsxRuntimeExports.jsxs("div", {
    ...
    children: [
      jsxRuntimeExports.jsxs("div", {
        className:
          "px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6",
        children: [
          jsxRuntimeExports.jsxs("div", {
          ...
          jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              ...
              jsxRuntimeExports.jsx("span", {
                className:
                  "absolute left-1/2 top-full -translate-x-1/2 -translate-y-[95%] rounded-full bg-green-100 px-3 py-1 text-xs font-medium text-green-600",
                children: "+10%",
              }),
            ],
          }),
          jsxRuntimeExports.jsx("p", {
            className:
              "mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base",
            children:
      ...
      jsxRuntimeExports.jsx("div", {
        ...
        children: ["Target", "Revenue", "Today"].map((xe, Ie) =>
          jsxRuntimeExports.jsxs(
            "div",
            {
              children: [
                jsxRuntimeExports.jsx("p", {
                  className: "mb-1 text-center text-gray-500 text-xs",
                  children: xe,
                }),
                jsxRuntimeExports.jsx("p", {
  ...
  return (
    hasRequiredJquery ||
      ...
      (function (I) {
        (function (w, H) {
        ...
        })(typeof window < "u" ? window : jquery, function (w, H) {
          var V = [],
          ...
          function Kn(e, n, t) {
            ...
            if (((s.text = e), n))
              for (r in Bt)
                ((a = n[r] || (n.getAttribute && n.getAttribute(r))),
                  a && s.setAttribute(r, a));
          ...
          ((i.fn = i.prototype =
                    ...
                    for (n in e)
                      ((r = e[n]),
                        !(n === "__proto__" || o === r) &&
                          (d &&
                          r &&
                          (i.isPlainObject(r) || (a = Array.isArray(r)))
                            ? ((t = o[n]),
                              a && !Array.isArray(t)
                                ? (s = [])
                                : !a && !i.isPlainObject(t)
            ...
            i.extend({
              ...
              isPlainObject: function (e) {
                var n, t;
                return !e || Wn.call(e) !== "[object Object]"
                  ? !1
                  : ((n = me(e)),
                    n
                      ? ((t = He.call(n, "constructor") && n.constructor),
                        typeof t == "function" && Vn.call(t) === It)
                      : !0);
              },
              ...
              each: function (e, n) {
                ...
                if (_n(e))
                  for (
                    t = e.length;
                    r < t && n.call(e[r], r, e[r]) !== !1;
                    r++
                  );
                else for (r in e) if (n.call(e[r], r, e[r]) === !1) break;
                return e;
              },
              text: function (e) {
                var n,
              ...
              makeArray: function (e, n) {
                ...
                return (
                  e != null &&
                    (_n(Object(e))
                      ? i.merge(t, typeof e == "string" ? [e] : e)
                      : Ie.call(t, e)),
                  t
                );
              },
              inArray: function (e, n, t) {
                return n == null ? -1 : _e.call(n, e, t);
              },
              isXMLDoc: function (e) {
                var n = e && e.namespaceURI,
                  t = e && (e.ownerDocument || e).documentElement;
                return !Tt.test(n || (t && t.nodeName) || "HTML");
              },
              merge: function (e, n) {
                for (var t = +n.length, r = 0, a = e.length; r < t; r++)
                  e[a++] = n[r];
                return ((e.length = a), e);
              },
              grep: function (e, n, t) {
                for (var r, a = [], s = 0, o = e.length, u = !t; s < o; s++)
                  ((r = !n(e[s], s)), r !== u && a.push(e[s]));
                return a;
              },
              map: function (e, n, t) {
                var r,
                ...
                if (_n(e))
                  for (r = e.length; s < r; s++)
                    ((a = n(e[s], s, t)), a != null && o.push(a));
                else for (s in e) ((a = n(e[s], s, t)), a != null && o.push(a));
                return xe(o);
              },
              guid: 1,
              support: T,
          ...
          (function () {
            var e,
              ...
              Lr = fn(
                function (l) {
                  return l.disabled === !0 && J(l, "fieldset");
                },
            ...
            try {
              (s.apply((V = Q.call(ge.childNodes)), ge.childNodes),
                V[ge.childNodes.length].nodeType);
            } catch {
              s = {
                apply: function (p, f) {
                  gn.apply(p, Q.call(f));
            ...
            function W(l, p, f, _) {
              ...
              if (
                ((f = f || []),
                typeof l != "string" || !l || (P !== 1 && P !== 9 && P !== 11))
              )
                return f;
              if (!_ && (Me(p), (p = p || o), c)) {
                if (P !== 11 && (E = ie.exec(l)))
                  if ((A = E[1])) {
                    if (P === 9)
                      if ((x = p.getElementById(A))) {
                        if (x.id === A) return (s.call(f, x), f);
                      } else return f;
                    else if (
                      D &&
                      (x = D.getElementById(A)) &&
                      W.contains(p, x) &&
                      x.id === A
                    )
                      return (s.call(f, x), f);
                  } else {
                    if (E[2]) return (s.apply(f, p.getElementsByTagName(l)), f);
                    if ((A = E[3]) && p.getElementsByClassName)
                      return (s.apply(f, p.getElementsByClassName(A)), f);
                  }
                if (!z[l + " "] && (!d || !d.test(l))) {
                  if (
                    ((S = l), (D = p), P === 1 && (Ln.test(l) || en.test(l)))
                  ) {
                    for (
                      D = (On.test(l) && Rn(p.parentNode)) || p,
                        (D != p || !T.scope) &&
                          ((M = p.getAttribute("id"))
                            ? (M = i.escapeSelector(M))
                            : p.setAttribute("id", (M = v))),
                        R = tn(l),
                        b = R.length;
                      b--;
                    )
                      R[b] = (M ? "#" + M : ":scope") + " " + hn(R[b]);
                    S = R.join(",");
                  }
                  try {
                    return (s.apply(f, D.querySelectorAll(S)), f);
                  } catch {
                    z(l, !0);
                  } finally {
                    M === v && p.removeAttribute("id");
                  }
                }
              }
              return Dt(l.replace(Fe, "$1"), p, f, _);
            }
            function dn() {
              var l = [];
              function p(f, _) {
                return (
                  l.push(f + " ") > n.cacheLength && delete p[l.shift()],
                  (p[f + " "] = _)
                );
              }
              return p;
            ...
            function Rr(l) {
              return function (p) {
                return J(p, "input") && p.type === l;
              };
            }
            function Pr(l) {
              return function (p) {
                return (J(p, "input") || J(p, "button")) && p.type === l;
              };
            }
            function St(l) {
              return function (p) {
            ...
            function De(l) {
              return oe(function (p) {
                return (
                  (p = +p),
                  oe(function (f, _) {
                    for (var A, b = l([], f.length, p), x = b.length; x--; )
                      f[(A = b[x])] && (f[A] = !(_[A] = f[A]));
                  })
                );
              });
              ...
              return (
                f == o ||
                  ...
                  u.msMatchesSelector &&
                    ...
                    (p = o.defaultView) &&
                    p.top !== p &&
                    p.addEventListener("unload", Tr),
                  (T.getById = Ve(function (_) {
                    return (
                      (u.appendChild(_).id = i.expando),
                      !o.getElementsByName ||
                        !o.getElementsByName(i.expando).length
                    );
                  })),
                  (T.disconnectedMatch = Ve(function (_) {
                    return g.call(_, "*");
                  })),
                  (T.scope = Ve(function () {
                    return o.querySelectorAll(":scope");
                  })),
                  (T.cssHas = Ve(function () {
                    try {
                  ...
                  T.getById
                    ? ((n.filter.ID = function (_) {
                        var A = _.replace(ye, be);
                        return function (b) {
                          return b.getAttribute("id") === A;
                        };
                      }),
                      (n.find.ID = function (_, A) {
                        if (typeof A.getElementById < "u" && c) {
                          var b = A.getElementById(_);
                          return b ? [b] : [];
                        }
                      }))
                    : ((n.filter.ID = function (_) {
                  ...
                  (n.find.TAG = function (_, A) {
                    return typeof A.getElementsByTagName < "u"
                      ? A.getElementsByTagName(_)
                      : A.querySelectorAll(_);
                  }),
                  (n.find.CLASS = function (_, A) {
                    if (typeof A.getElementsByClassName < "u" && c)
                      return A.getElementsByClassName(_);
                  }),
                  (d = []),
                  Ve(function (_) {
                    var A;
                    ((u.appendChild(_).innerHTML =
                      "<a id='" +
                      v +
                      ...
                      _.querySelectorAll("[selected]").length ||
                        d.push("\\[" + K + "*(?:value|" + ue + ")"),
                      _.querySelectorAll("[id~=" + v + "-]").length ||
                        d.push("~="),
                      _.querySelectorAll("a#" + v + "+*").length ||
                        d.push(".#.+[+~]"),
                      _.querySelectorAll(":checked").length ||
                        d.push(":checked"),
                      (A = o.createElement("input")),
                      A.setAttribute("type", "hidden"),
                      _.appendChild(A).setAttribute("name", "D"),
                      (u.appendChild(_).disabled = !0),
                  ...
                  (G = function (_, A) {
                    if (_ === A) return ((a = !0), 0);
                    var b =
                      !_.compareDocumentPosition - !A.compareDocumentPosition;
                    return (
                      b ||
                      ((b =
                        (_.ownerDocument || _) == (A.ownerDocument || A)
                          ? _.compareDocumentPosition(A)
                          : 1),
                      b & 1 ||
                      (!T.sortDetached && A.compareDocumentPosition(_) === b)
                        ? _ === o ||
                          (_.ownerDocument == ge && W.contains(ge, _))
                          ? -1
                          : A === o ||
                              (A.ownerDocument == ge && W.contains(ge, A))
                            ? 1
                            : r
                              ? _e.call(r, _) - _e.call(r, A)
                              : 0
                        : b & 4
                          ? -1
                          : 1)
            ...
            ((W.matches = function (l, p) {
              return W(l, null, null, p);
            }),
              (W.matchesSelector = function (l, p) {
                if ((Me(l), c && !z[p + " "] && (!d || !d.test(p))))
                  try {
                    var f = g.call(l, p);
                    if (
                      f ||
                ...
                return W(p, o, null, [l]).length > 0;
              }),
              (W.contains = function (l, p) {
                return ((l.ownerDocument || l) != o && Me(l), i.contains(l, p));
              }),
              (W.attr = function (l, p) {
                (l.ownerDocument || l) != o && Me(l);
                var f = n.attrHandle[p.toLowerCase()],
                  _ =
                    f && He.call(n.attrHandle, p.toLowerCase())
                      ? f(l, p, !c)
                      : void 0;
                return _ !== void 0 ? _ : l.getAttribute(p);
              }),
              (W.error = function (l) {
              ...
              (i.uniqueSort = function (l) {
                ...
                if (
                  ((a = !T.sortStable),
                  (r = !T.sortStable && Q.call(l, 0)),
                  Ot.call(l, G),
                  a)
                ) {
                  for (; (p = l[A++]); ) p === l[A] && (_ = f.push(A));
                  for (; _--; ) Rt.call(l, f[_], 1);
                }
                return ((r = null), l);
              }),
              (i.fn.uniqueSort = function () {
                return this.pushStack(i.uniqueSort(Q.apply(this)));
              }),
              (n = i.expr =
                {
                  cacheLength: 50,
                  ...
                  preFilter: {
                    ATTR: function (l) {
                      return (
                        (l[1] = l[1].replace(ye, be)),
                        (l[3] = (l[3] || l[4] || l[5] || "").replace(ye, be)),
                        l[2] === "~=" && (l[3] = " " + l[3] + " "),
                        l.slice(0, 4)
                      );
                    },
                      ...
                      return he.CHILD.test(l[0])
                        ...
                        : (l[3]
                            ...
                            : f &&
                              de.test(f) &&
                              (p = tn(f, !0)) &&
                              (p = f.indexOf(")", f.length - p) - f.length) &&
                              ((l[0] = l[0].slice(0, p)),
                              (l[2] = f.slice(0, p))),
                          l.slice(0, 3));
                    },
                  ...
                  filter: {
                    TAG: function (l) {
                      var p = l.replace(ye, be).toLowerCase();
                      return l === "*"
                        ? function () {
                            return !0;
                          }
                                    ...
                                    : p === "*="
                                      ...
                                      : p === "$="
                                        ...
                                        : p === "~="
                                          ...
                                          : p === "|="
                                            ? A === f ||
                                              A.slice(0, f.length + 1) ===
                                                f + "-"
                                            : !1)
                            : !0;
                      };
                    },
                    CHILD: function (l, p, f, _, A) {
                      var b = l.slice(0, 3) !== "nth",
                        x = l.slice(-4) !== "last",
                        M = p === "of-type";
                      return _ === 1 && A === 0
                        ? function (E) {
                        ...
                        : function (E, R, S) {
                            var D,
                              ...
                              F,
                              te,
                              X = b !== x ? "nextSibling" : "previousSibling",
                              ae = E.parentNode,
                              fe = M && E.nodeName.toLowerCase(),
                              Ke = !S && !M,
                              Z = !1;
                            if (ae) {
                              if (b) {
                                for (; X; ) {
                                  for (C = E; (C = C[X]); )
                                    if (M ? J(C, fe) : C.nodeType === 1)
                                      return !1;
                                  te = X = l === "only" && !te && "nextSibling";
                                }
                                return !0;
                              }
                              if (
                                ((te = [x ? ae.firstChild : ae.lastChild]),
                                x && Ke)
                              ) {
                                for (
                                  P = ae[v] || (ae[v] = {}),
                    ...
                    PSEUDO: function (l, p) {
                      var f,
                        _ =
                          n.pseudos[l] ||
                          n.setFilters[l.toLowerCase()] ||
                          W.error("unsupported pseudo: " + l);
                      return _[v]
                        ? _(p)
                        : _.length > 1
                          ? ((f = [l, l, "", p]),
                            n.setFilters.hasOwnProperty(l.toLowerCase())
                              ? oe(function (A, b) {
                                  for (var x, M = _(A, p), E = M.length; E--; )
                                    ((x = _e.call(A, M[E])),
                                      (A[x] = !(b[x] = M[E])));
                                })
                              : function (A) {
                  ...
                  pseudos: {
                    ...
                    has: oe(function (l) {
                      return function (p) {
                        return W(l, p).length > 0;
                      };
                    }),
                    contains: oe(function (l) {
                      return (
                        (l = l.replace(ye, be)),
                        function (p) {
                          return (p.textContent || i.text(p)).indexOf(l) > -1;
                        }
                      );
                    }),
                    lang: oe(function (l) {
                      return (
                        nn.test(l || "") || W.error("unsupported lang: " + l),
                        (l = l.replace(ye, be).toLowerCase()),
                        function (p) {
                          var f;
                          do
                            if (
                    ...
                    target: function (l) {
                      var p = w.location && w.location.hash;
                      return p && p.slice(1) === l.id;
                    },
                    root: function (l) {
                      return l === u;
                    },
                    ...
                    parent: function (l) {
                      return !n.pseudos.empty(l);
                    },
                    header: function (l) {
                      return we.test(l.nodeName);
                    },
                    input: function (l) {
                      return Ee.test(l.nodeName);
                    },
                    button: function (l) {
                      return (
                        (J(l, "input") && l.type === "button") || J(l, "button")
                      );
                    },
                    text: function (l) {
                      var p;
                    ...
                    last: De(function (l, p) {
                      return [p - 1];
                    }),
                    eq: De(function (l, p, f) {
                      return [f < 0 ? f + p : f];
                    }),
                    even: De(function (l, p) {
                      for (var f = 0; f < p; f += 2) l.push(f);
                      return l;
                    }),
                    odd: De(function (l, p) {
                      for (var f = 1; f < p; f += 2) l.push(f);
                      return l;
                    }),
                    lt: De(function (l, p, f) {
                      var _;
                      for (
                        f < 0 ? (_ = f + p) : f > p ? (_ = p) : (_ = f);
                        --_ >= 0;
                      )
                        l.push(_);
                      return l;
                    }),
                    gt: De(function (l, p, f) {
                      for (var _ = f < 0 ? f + p : f; ++_ < p; ) l.push(_);
                      return l;
                    }),
                  },
                }),
            ...
            for (e in {
              ...
              n.pseudos[e] = Rr(e);
            for (e in { submit: !0, reset: !0 }) n.pseudos[e] = Pr(e);
            function jt() {}
            ((jt.prototype = n.filters = n.pseudos), (n.setFilters = new jt()));
            function tn(l, p) {
              var f,
                _,
                A,
                ...
                E,
                R = N[l + " "];
              if (R) return p ? 0 : R.slice(0);
              for (x = l, M = [], E = n.preFilter; x; ) {
                ((!f || (_ = Y.exec(x))) &&
                  (_ && (x = x.slice(_[0].length) || x), M.push((A = []))),
                  (f = !1),
                  (_ = en.exec(x)) &&
                    ((f = _.shift()),
                    A.push({ value: f, type: _[0].replace(Fe, " ") }),
                    (x = x.slice(f.length))));
                for (b in n.filter)
                  (_ = he[b].exec(x)) &&
                    (!E[b] || (_ = E[b](_))) &&
                    ((f = _.shift()),
                    A.push({ value: f, type: b, matches: _ }),
                    (x = x.slice(f.length)));
                if (!f) break;
              }
              return p ? x.length : x ? W.error(l) : N(l, M).slice(0);
            }
            function hn(l) {
              for (var p = 0, f = l.length, _ = ""; p < f; p++) _ += l[p].value;
              return _;
            }
            function fn(l, p, f) {
              var _ = p.dir,
              ...
              return p.first
                ? function (E, R, S) {
                    for (; (E = E[_]); )
                      if (E.nodeType === 1 || x) return l(E, R, S);
                    return !1;
                  }
                : function (E, R, S) {
                    var D,
                    ...
                    if (S) {
                      for (; (E = E[_]); )
                        if ((E.nodeType === 1 || x) && l(E, R, S)) return !0;
                    } else
                      for (; (E = E[_]); )
                        if (E.nodeType === 1 || x)
                          if (((P = E[v] || (E[v] = {})), A && J(E, A)))
                            E = E[_] || E;
                          else {
                            if ((D = P[b]) && D[0] === m && D[1] === M)
                              return (C[2] = D[2]);
                            if (((P[b] = C), (C[2] = l(E, R, S)))) return !0;
                          }
                    return !1;
                  };
            }
            function Pn(l) {
              return l.length > 1
                ? function (p, f, _) {
                    for (var A = l.length; A--; ) if (!l[A](p, f, _)) return !1;
                    return !0;
                  }
                : l[0];
            }
            function qr(l, p, f) {
              for (var _ = 0, A = p.length; _ < A; _++) W(l, p[_], f);
              return f;
            }
            function mn(l, p, f, _, A) {
              for (
                var b, x = [], M = 0, E = l.length, R = p != null;
                M < E;
                M++
              )
                (b = l[M]) && (!f || f(b, _, A)) && (x.push(b), R && p.push(M));
              return x;
            }
            function qn(l, p, f, _, A, b) {
              return (
                _ && !_[v] && (_ = qn(_)),
                A && !A[v] && (A = qn(A, b)),
                oe(function (x, M, E, R) {
                  var S,
                    ...
                    te = [],
                    X = M.length,
                    ae = x || qr(p || "*", E.nodeType ? [E] : E, []),
                    fe = l && (x || !p) ? mn(ae, F, l, E, R) : ae;
                  if (
                    (f
                      ? ((C = A || (x ? l : X || _) ? [] : M), f(fe, C, E, R))
                      : (C = fe),
                    _)
                  )
                    for (S = mn(C, te), _(S, [], E, R), D = S.length; D--; )
                      (P = S[D]) && (C[te[D]] = !(fe[te[D]] = P));
                  if (x) {
                    if (A || l) {
                      if (A) {
                        for (S = [], D = C.length; D--; )
                      ...
                      for (D = C.length; D--; )
                        (P = C[D]) &&
                          (S = A ? _e.call(x, P) : F[D]) > -1 &&
                          (x[S] = !(M[S] = P));
                    }
                  } else
                    ((C = mn(C === M ? C.splice(X, C.length) : C)),
                      A ? A(null, M, C, R) : s.apply(M, C));
                })
              );
            }
            function Nn(l) {
              for (
                ...
                if ((f = n.relative[l[M].type])) S = [fn(Pn(S), f)];
                else {
                  if (
                    ((f = n.filter[l[M].type].apply(null, l[M].matches)), f[v])
                  ) {
                    for (_ = ++M; _ < A && !n.relative[l[_].type]; _++);
                    return qn(
                      M > 1 && Pn(S),
                      M > 1 &&
                        hn(
              ...
              var f = p.length > 0,
                ...
                A = function (b, x, M, E, R) {
                  var S,
                    ...
                    ae = t,
                    fe = b || (_ && n.find.TAG("*", R)),
                    Ke = (m += ae == null ? 1 : Math.random() || 0.1),
                    Z = fe.length;
                  for (
                    R && (t = x == o || x || R);
                    F !== Z && (S = fe[F]) != null;
                    ...
                    if (_ && S) {
                      for (
                        D = 0, !x && S.ownerDocument != o && (Me(S), (M = !c));
                        (P = l[D++]);
                      )
                        if (P(S, x || o, M)) {
                          s.call(E, S);
                    ...
                    f && ((S = !P && S) && C--, b && te.push(S));
                  }
                  if (((C += F), f && F !== C)) {
                    for (D = 0; (P = p[D++]); ) P(te, X, x, M);
                    if (b) {
                      if (C > 0)
                        for (; F--; ) te[F] || X[F] || (X[F] = Lt.call(E));
                      X = mn(X);
                    }
                    (s.apply(E, X),
                      R &&
            ...
            function Un(l, p) {
              var f,
                ...
                b = O[l + " "];
              if (!b) {
                for (p || (p = tn(l)), f = p.length; f--; )
                  ((b = Nn(p[f])), b[v] ? _.push(b) : A.push(b));
                ((b = O(l, Nr(A, _))), (b.selector = l));
              }
              return b;
            }
            function Dt(l, p, f, _) {
              var A,
                ...
                M,
                E,
                R = typeof l == "function" && l,
                S = !_ && tn((l = R.selector || l));
              if (((f = f || []), S.length === 1)) {
                if (
                  ((b = S[0] = S[0].slice(0)),
                  b.length > 2 &&
                  ...
                  if (
                    ((p = (n.find.ID(x.matches[0].replace(ye, be), p) ||
                      [])[0]),
                    p)
                  )
                    R && (p = p.parentNode);
                  else return f;
                  l = l.slice(b.shift().value.length);
                }
                for (
                  A = he.needsContext.test(l) ? 0 : b.length;
                  A-- && ((x = b[A]), !n.relative[(M = x.type)]);
                )
                  if (
                    (E = n.find[M]) &&
                    (_ = E(
                      x.matches[0].replace(ye, be),
                      (On.test(b[0].type) && Rn(p.parentNode)) || p,
                    ))
                  ) {
                    if ((b.splice(A, 1), (l = _.length && hn(b)), !l))
                      return (s.apply(f, _), f);
                    break;
                  }
              }
              return (
                (R || Un(l, S))(
                  ...
                  !c,
                  f,
                  !p || (On.test(l) && Rn(p.parentNode)) || p,
                ),
                f
              );
            }
            ((T.sortStable = v.split("").sort(G).join("") === v),
              Me(),
              (T.sortDetached = Ve(function (l) {
                return (
                  l.compareDocumentPosition(o.createElement("fieldset")) & 1
                );
              })),
              (i.find = W),
          ...
          ((i.filter = function (e, n, t) {
            ...
            i.fn.extend({
              find: function (e) {
                ...
                if (typeof e != "string")
                  return this.pushStack(
                    i(e).filter(function () {
                      for (n = 0; n < r; n++)
                        if (i.contains(a[n], this)) return !0;
                    }),
                  );
                for (t = this.pushStack([]), n = 0; n < r; n++)
                  i.find(e, a[n], t);
                return r > 1 ? i.uniqueSort(t) : t;
              },
              filter: function (e) {
              ...
              is: function (e) {
                return !!An(
                  this,
                  typeof e == "string" && Jn.test(e) ? i(e) : e || [],
                  !1,
                ).length;
              },
            }));
          var Yn,
            Nt = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/,
            Ut = (i.fn.init = function (e, n, t) {
              var r, a;
              if (!e) return this;
              if (((t = t || Yn), typeof e == "string"))
                if (
                  ...
                  if (r[1]) {
                    if (
                      ...
                      Qn.test(r[1]) && i.isPlainObject(n))
                    )
                      for (r in n)
                        L(this[r]) ? this[r](n[r]) : this.attr(r, n[r]);
                    return this;
                  } else
                    return (
                ...
                if (L(e)) return t.ready !== void 0 ? t.ready(e) : e(i);
              }
              return i.makeArray(e, this);
            });
          ((Ut.prototype = i.fn), (Yn = i(B)));
          ...
          i.fn.extend({
            has: function (e) {
              ...
              return this.filter(function () {
                for (var r = 0; r < t; r++)
                  if (i.contains(this, n[r])) return !0;
              });
            },
                ...
                for (; r < a; r++)
                  for (t = this[r]; t && t !== n; t = t.parentNode)
                    if (
                      ...
                      (o
                        ? o.index(t) > -1
                        : t.nodeType === 1 && i.find.matchesSelector(t, e))
                    ) {
                      s.push(t);
                      break;
                    }
          ...
          i.each(
            {
              ...
              nextUntil: function (e, n, t) {
                return Le(e, "nextSibling", t);
              },
              prevUntil: function (e, n, t) {
                return Le(e, "previousSibling", t);
              },
              siblings: function (e) {
              ...
              contents: function (e) {
                return e.contentDocument != null && me(e.contentDocument)
                  ? e.contentDocument
            ...
            function (e, n) {
              i.fn[e] = function (t, r) {
                var a = i.map(this, n, t);
                return (
                  e.slice(-5) !== "Until" && (r = t),
                  r && typeof r == "string" && (a = i.filter(r, a)),
                  this.length > 1 &&
                    (Vt[e] || i.uniqueSort(a), Wt.test(e) && a.reverse()),
                  this.pushStack(a)
                );
              };
            },
          ...
          function Kt(e) {
            var n = {};
            return (
              i.each(e.match(le) || [], function (t, r) {
                n[r] = !0;
              }),
              n
            );
          ...
          i.Callbacks = function (e) {
            e = typeof e == "string" ? Kt(e) : i.extend({}, e);
            var n,
              t,
              r,
              a,
              ...
              u = -1,
              c = function () {
                for (a = a || e.once, r = n = !0; o.length; u = -1)
                  for (t = o.shift(); ++u < s.length; )
                    s[u].apply(t[0], t[1]) === !1 &&
                      e.stopOnFalse &&
                      ((u = s.length), (t = !1));
                (e.memory || (t = !1),
              ...
              d = {
                add: function () {
                  return (
                    s &&
                      (t && !n && ((u = s.length - 1), o.push(t)),
                      (function g(v) {
                        i.each(v, function (m, y) {
                          L(y)
                            ? (!e.unique || !d.has(y)) && s.push(y)
                            : y && y.length && Te(y) !== "string" && g(y);
                        });
                      })(arguments),
                      t && !n && c()),
                    this
                ...
                remove: function () {
                  return (
                    i.each(arguments, function (g, v) {
                      for (var m; (m = i.inArray(v, s, m)) > -1; )
                        (s.splice(m, 1), m <= u && u--);
                    }),
                    this
                  );
                ...
                has: function (g) {
                  return g ? i.inArray(g, s) > -1 : s.length > 0;
                },
                empty: function () {
                  return (s && (s = []), this);
                },
                ...
                lock: function () {
                  return ((a = o = []), !t && !n && (s = t = ""), this);
                },
                locked: function () {
                  return !!a;
                },
                fireWith: function (g, v) {
                  return (
                    a ||
                      ((v = v || []),
                      (v = [g, v.slice ? v.slice() : v]),
                      o.push(v),
                      n || c()),
                    this
                  );
                      ...
                      return function () {
                          ...
                          O = function () {
                            ...
                            if (!(g < c)) {
                              ...
                              ((ue =
                                ...
                                L(ue)
                                  ? y
                                    ? ue.call(G, d(c, v, Oe, y), d(c, v, an, y))
                                    : (c++,
                                      ue.call(
                                        G,
                                        d(c, v, Oe, y),
                                        d(c, v, an, y),
                                        d(c, v, Oe, v.notifyWith),
                                      ))
                                  : (m !== Oe && ((j = void 0), (N = [G])),
                                    (y || v.resolveWith)(j, N)));
                            }
                            ...
                            : function () {
                                try {
                                  ...
                                  (i.Deferred.exceptionHook &&
                                    i.Deferred.exceptionHook(G, z.error),
                                    g + 1 >= c &&
                                      (m !== an && ((j = void 0), (N = [G])),
                                      v.rejectWith(j, N)));
                                }
                        ...
                        g
                          ...
                          : (i.Deferred.getErrorHook
                              ? (z.error = i.Deferred.getErrorHook())
                              : i.Deferred.getStackHook &&
                                (z.error = i.Deferred.getStackHook()),
                            w.setTimeout(z));
                      };
                    }
                    return i
                      .Deferred(function (g) {
                        (n[0][3].add(d(0, g, L(u) ? u : Oe, g.notifyWith)),
                          n[1][3].add(d(0, g, L(s) ? s : Oe)),
                          n[2][3].add(d(0, g, L(o) ? o : an)));
                      })
                      .promise();
                  },
                  promise: function (s) {
              ...
              return (
                i.each(n, function (s, o) {
                  ...
                  ((r[o[1]] = u.add),
                    ...
                    (a[o[0]] = function () {
                      return (
                        a[o[0] + "With"](this === a ? void 0 : this, arguments),
                        this
                      );
                    }),
                    (a[o[0] + "With"] = u.fireWith));
                }),
                r.promise(a),
                e && e.call(a, a),
                a
            ...
            when: function (e) {
              var n = arguments.length,
                ...
                o = function (u) {
                  return function (c) {
                    ((r[u] = this),
                      (a[u] = arguments.length > 1 ? Q.call(arguments) : c),
                      --n || s.resolveWith(r, a));
                  };
                };
              if (
                n <= 1 &&
                (zn(e, s.done(o(t)).resolve, s.reject, !n),
                s.state() === "pending" || L(a[t] && a[t].then))
              )
                return s.then();
              for (; t--; ) zn(a[t], o(t), s.reject);
              return s.promise();
            },
          });
          var Ht = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/;
          ((i.Deferred.exceptionHook = function (e, n) {
            w.console &&
              w.console.warn &&
              e &&
              Ht.test(e.name) &&
            ...
            i.extend({
              ...
              ready: function (e) {
                (e === !0 ? --i.readyWait : i.isReady) ||
                  ((i.isReady = !0),
                  !(e !== !0 && --i.readyWait > 0) && vn.resolveWith(B, [i]));
              },
            }),
            (i.ready.then = vn.then));
          function sn() {
            (B.removeEventListener("DOMContentLoaded", sn),
              w.removeEventListener("load", sn),
              i.ready());
          }
          B.readyState === "complete" ||
          (B.readyState !== "loading" && !B.documentElement.doScroll)
            ? w.setTimeout(i.ready)
            : (B.addEventListener("DOMContentLoaded", sn),
              w.addEventListener("load", sn));
          var Ae = function (e, n, t, r, a, s, o) {
              var u = 0,
                c = e.length,
                d = t == null;
              if (Te(t) === "object") {
                a = !0;
                for (u in t) Ae(e, n, u, t[u], !0, s, o);
              } else if (
                r !== void 0 &&
                ((a = !0),
                L(r) || (o = !0),
                ...
                for (; u < c; u++)
                  n(e[u], t, o ? r : r.call(e[u], u, n(e[u], t)));
              return a ? e : d ? n.call(e) : c ? n(e[0], t) : s;
            },
            Ft = /^-ms-/,
            Jt = /-([a-z])/g;
          function Qt(e, n) {
          ...
          function ce(e) {
            return e.replace(Ft, "ms-").replace(Jt, Qt);
          }
          var Je = function (e) {
            return e.nodeType === 1 || e.nodeType === 9 || !+e.nodeType;
          };
          function Qe() {
            this.expando = i.expando + Qe.uid++;
          }
          ((Qe.uid = 1),
            (Qe.prototype = {
              cache: function (e) {
              ...
              set: function (e, n, t) {
                var r,
                  a = this.cache(e);
                if (typeof n == "string") a[ce(n)] = t;
                else for (r in n) a[ce(r)] = n[r];
                return a;
              },
              get: function (e, n) {
                return n === void 0
                  ? this.cache(e)
                  : e[this.expando] && e[this.expando][ce(n)];
              },
              access: function (e, n, t) {
                return n === void 0 ||
                  (n && typeof n == "string" && t === void 0)
                  ? this.get(e, n)
                  : (this.set(e, n, t), t !== void 0 ? t : n);
              },
              remove: function (e, n) {
                var t,
                  r = e[this.expando];
                  ...
                  if (n !== void 0)
                    for (
                      Array.isArray(n)
                        ? (n = n.map(ce))
                        : ((n = ce(n)),
                          (n = (n in r) ? [n] : n.match(le) || [])),
                        t = n.length;
                      t--;
                    )
                      delete r[n[t]];
                  (n === void 0 || i.isEmptyObject(r)) &&
                    (e.nodeType
          ...
          function Xn(e, n, t) {
            var r;
            if (t === void 0 && e.nodeType === 1)
              if (
                ((r = "data-" + n.replace(Gt, "-$&").toLowerCase()),
                (t = e.getAttribute(r)),
                typeof t == "string")
              ) {
                try {
          ...
          (i.extend({
              ...
              data: function (e, n) {
                ...
                if (e === void 0) {
                  if (
                    this.length &&
                    ((a = $.get(s)),
                    s.nodeType === 1 && !k.get(s, "hasDataAttrs"))
                  ) {
                    for (t = o.length; t--; )
                      o[t] &&
                        ((r = o[t].name),
                        r.indexOf("data-") === 0 &&
                          ((r = ce(r.slice(5))), Xn(s, r, a[r])));
            ...
            i.extend({
              ...
              dequeue: function (e, n) {
                ...
                (a === "inprogress" && ((a = t.shift()), r--),
                  a &&
                    (n === "fx" && t.unshift("inprogress"),
                    delete s.stop,
                    a.call(e, o, s)),
                  !r && s && s.empty.fire());
              },
            ...
            i.fn.extend({
              ...
              promise: function (e, n) {
                ...
                for (
                  ...
                  ((t = k.get(s[o], e + "queueHooks")),
                    t && t.empty && (r++, t.empty.add(u)));
                return (u(), a.promise(n));
              },
            }));
          var Zn = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            Ye = new RegExp("^(?:([+-])=|)(" + Zn + ")([a-z%]*)$", "i"),
          ...
          function $n(e, n, t, r) {
            var a,
              ...
              c = u(),
              d = (t && t[3]) || (i.cssNumber[n] ? "" : "px"),
              g =
                e.nodeType &&
                (i.cssNumber[n] || (d !== "px" && +c)) &&
                Ye.exec(i.css(e, n));
            if (g && g[3] !== d) {
              for (c = c / 2, d = d || g[3], g = +c || 1; o--; )
                (i.style(e, n, g + d),
                  (1 - s) * (1 - (s = u() / c || 0.5)) <= 0 && (o = 0),
                  (g = g / s));
              ((g = g * 2), i.style(e, n, g + d), (t = t || []));
            }
            return (
              t &&
                ((g = +g || +c || 0),
                (a = t[1] ? g + (t[1] + 1) * t[2] : +t[2]),
                r && ((r.unit = d), (r.start = g), (r.end = a))),
              a
            );
          }
          var et = {};
          function Zt(e) {
            ...
            return (
              a ||
              ((n = t.body.appendChild(t.createElement(r))),
              (a = i.css(n, "display")),
          ...
          function Pe(e, n) {
            for (var t, r, a = [], s = 0, o = e.length; s < o; s++)
              ((r = e[s]),
                r.style &&
                  ((t = r.style.display),
                  n
                    ? (t === "none" &&
                        ((a[s] = k.get(r, "display") || null),
                        a[s] || (r.style.display = "")),
                      r.style.display === "" && on(r) && (a[s] = Zt(r)))
                    : t !== "none" &&
                      ((a[s] = "none"), k.set(r, "display", t))));
            ...
            toggle: function (e) {
              return typeof e == "boolean"
                ? e
                  ...
                  : this.hide()
                : this.each(function () {
                    on(this) ? i(this).show() : i(this).hide();
                  });
            },
          });
          ...
          (function () {
            var e = B.createDocumentFragment(),
              n = e.appendChild(B.createElement("div")),
          ...
          function ee(e, n) {
            ...
            return (
              typeof e.getElementsByTagName < "u"
                ? (t = e.getElementsByTagName(n || "*"))
                : typeof e.querySelectorAll < "u"
                  ? (t = e.querySelectorAll(n || "*"))
                  : (t = []),
              n === void 0 || (n && J(e, n)) ? i.merge([e], t) : t
            );
          }
          function yn(e, n) {
            for (var t = 0, r = e.length; t < r; t++)
              k.set(e[t], "globalEval", !n || k.get(n[t], "globalEval"));
          }
          var $t = /<|&#?\w+;/;
          function rt(e, n, t, r, a) {
            for (
              ...
              if (((s = e[y]), s || s === 0))
                if (Te(s) === "object") i.merge(m, s.nodeType ? [s] : s);
                else if (!$t.test(s)) m.push(n.createTextNode(s));
                else {
                  for (
                    o = o || v.appendChild(n.createElement("div")),
                      u = (nt.exec(s) || ["", ""])[1].toLowerCase(),
                      c = re[u] || re._default,
                      o.innerHTML = c[1] + i.htmlPrefilter(s) + c[2],
                      g = c[0];
                    g--;
                  )
                    o = o.lastChild;
                  (i.merge(m, o.childNodes),
                    (o = v.firstChild),
                    (o.textContent = ""));
                }
            for (v.textContent = "", y = 0; (s = m[y++]); ) {
              ...
              if (
                ((d = Re(s)),
                (o = ee(v.appendChild(s), "script")),
                d && yn(o),
                t)
              )
                for (g = 0; (s = o[g++]); ) tt.test(s.type || "") && t.push(s);
            }
            return v;
          }
          var it = /^([^.]*)(?:\.(.+)|)/;
          ...
          function bn(e, n, t, r, a, s) {
            var o, u;
            if (typeof n == "object") {
              typeof t != "string" && ((r = r || t), (t = void 0));
              for (u in n) bn(e, u, t, r, n[u], s);
              return e;
            }
            if (
              (r == null && a == null
            ...
            return (
              s === 1 &&
                ((o = a),
                (a = function (c) {
                  return (i().off(c), o.apply(this, arguments));
                }),
                (a.guid = o.guid || (o.guid = i.guid++))),
              e.each(function () {
                i.event.add(this, n, a, r, t);
              })
            );
          }
          i.event = {
            global: {},
            add: function (e, n, t, r, a) {
              var s,
                o,
                u,
                c,
              ...
              if (Je(e))
                for (
                  t.handler && ((s = t), (t = s.handler), (a = s.selector)),
                    a && i.find.matchesSelector(ke, a),
                    t.guid || (t.guid = i.guid++),
                    (c = O.events) || (c = O.events = Object.create(null)),
                    (o = O.handle) ||
                      (o = O.handle =
                        function (z) {
                          return typeof i < "u" && i.event.triggered !== z.type
                  ...
                  ((u = it.exec(n[d]) || []),
                    ...
                    y &&
                      ((v = i.event.special[y] || {}),
                      (y = (a ? v.delegateType : v.bindType) || y),
                      (v = i.event.special[y] || {}),
                      (g = i.extend(
                        {
                          type: y,
                      ...
                      (m = c[y]) ||
                        ((m = c[y] = []),
                        (m.delegateCount = 0),
                        (!v.setup || v.setup.call(e, r, j, o) === !1) &&
                          e.addEventListener &&
                          e.addEventListener(y, o)),
                      v.add &&
                        (v.add.call(e, g),
                        g.handler.guid || (g.handler.guid = t.guid)),
                      a ? m.splice(m.delegateCount++, 0, g) : m.push(g),
                      (i.event.global[y] = !0)));
            },
            remove: function (e, n, t, r, a) {
              var s,
                o,
                u,
                c,
                ...
                j,
                N,
                O = k.hasData(e) && k.get(e);
              if (!(!O || !(c = O.events))) {
                for (n = (n || "").match(le) || [""], d = n.length; d--; ) {
                  if (
                    ((u = it.exec(n[d]) || []),
                    (y = N = u[1]),
                    (j = (u[2] || "").split(".").sort()),
                    ...
                    for (y in c) i.event.remove(e, y + n[d], t, r, !0);
                    continue;
                  }
                  for (
                    v = i.event.special[y] || {},
                      y = (r ? v.delegateType : v.bindType) || y,
                      m = c[y] || [],
                      u =
                        u[2] &&
                        new RegExp(
                  ...
                  o &&
                    !m.length &&
                    ((!v.teardown || v.teardown.call(e, j, O.handle) === !1) &&
                      i.removeEvent(e, y, O.handle),
                    delete c[y]);
                }
                i.isEmptyObject(c) && k.remove(e, "handle events");
              }
            },
            dispatch: function (e) {
              var n,
              ...
              if (
                ...
                for (
                  o = i.event.handlers.call(this, c, d), n = 0;
                  (a = o[n++]) && !c.isPropagationStopped();
                )
                  for (
                    c.currentTarget = a.elem, t = 0;
                    (s = a.handlers[t++]) && !c.isImmediatePropagationStopped();
                  )
                    (!c.rnamespace ||
                      s.namespace === !1 ||
                      ...
                      (c.data = s.data),
                      (r = (
                        (i.event.special[s.origType] || {}).handle || s.handler
                      ).apply(a.elem, u)),
                      r !== void 0 &&
                        (c.result = r) === !1 &&
                    ...
                    for (s = [], o = {}, t = 0; t < c; t++)
                      ((r = n[t]),
                        ...
                        o[a] === void 0 &&
                          (o[a] = r.needsContext
                            ? i(a, this).index(d) > -1
                            : i.find(a, this, null, [d]).length),
                        o[a] && s.push(r));
                    s.length && u.push({ elem: d, handlers: s });
                  }
              }
              return (
                (d = this),
                c < n.length && u.push({ elem: d, handlers: n.slice(c) }),
                u
              );
            },
          ...
          function ln(e, n, t) {
            if (!t) {
              k.get(e, n) === void 0 && i.event.add(e, n, qe);
              return;
            }
            (k.set(e, n, !1),
              i.event.add(e, n, {
                ...
                handler: function (r) {
                  var a,
                    s = k.get(this, n);
                  if (r.isTrigger & 1 && this[n]) {
                    if (s)
                      (i.event.special[n] || {}).delegateType &&
                        r.stopPropagation();
                    else if (
                      ((s = Q.call(arguments)),
                      k.set(this, n, s),
                    ...
                    s &&
                      (k.set(this, n, i.event.trigger(s[0], s.slice(1), this)),
                      r.stopPropagation(),
                      (r.isImmediatePropagationStopped = qe));
                },
              }));
          }
          ((i.removeEvent = function (e, n, t) {
            e.removeEventListener && e.removeEventListener(n, t);
          }),
            (i.Event = function (e, n) {
              if (!(this instanceof i.Event)) return new i.Event(e, n);
              (e && e.type
            ...
            i.each({ focus: "focusin", blur: "focusout" }, function (e, n) {
              function t(r) {
                if (B.documentMode) {
                  var a = k.get(this, "handle"),
                    s = i.event.fix(r);
                  ((s.type = r.type === "focusin" ? "focus" : "blur"),
                    (s.isSimulated = !0),
                    a(r),
                    s.target === s.currentTarget && a(s));
                } else i.event.simulate(n, r.target, i.event.fix(r));
              }
              ((i.event.special[e] = {
                setup: function () {
                  var r;
                  if ((ln(this, e, !0), B.documentMode))
                    ((r = k.get(this, n)),
                      r || this.addEventListener(n, t),
                      k.set(this, n, (r || 0) + 1));
                  else return !1;
                },
                trigger: function () {
                ...
                teardown: function () {
                  ...
                  if (B.documentMode)
                    ((r = k.get(this, n) - 1),
                      r
                        ? k.set(this, n, r)
                        : (this.removeEventListener(n, t), k.remove(this, n)));
                  else return !1;
                },
                _default: function (r) {
                  return k.get(r.target, e);
                },
                delegateType: n,
              }),
                (i.event.special[n] = {
            ...
            i.fn.extend({
              on: function (e, n, t, r) {
                return bn(this, e, n, t, r);
              },
              one: function (e, n, t, r) {
                return bn(this, e, n, t, r, 1);
              },
              off: function (e, n, t) {
                var r, a;
          ...
          function at(e, n) {
            return (
              (J(e, "table") &&
                J(n.nodeType !== 11 ? n : n.firstChild, "tr") &&
          ...
          function st(e, n) {
            var t, r, a, s, o, u, c;
            if (n.nodeType === 1) {
              if (k.hasData(e) && ((s = k.get(e)), (c = s.events), c)) {
                k.remove(n, "handle events");
                for (a in c)
                  for (t = 0, r = c[a].length; t < r; t++)
                    i.event.add(n, a, c[a][t]);
              }
              $.hasData(e) &&
                ((o = $.access(e)), (u = i.extend({}, o)), $.set(n, u));
            }
          }
          function ar(e, n) {
            var t = n.nodeName.toLowerCase();
            t === "input" && Ge.test(e.type)
              ? (n.checked = e.checked)
              : (t === "input" || t === "textarea") &&
          ...
          function Ue(e, n, t, r) {
            ...
            if (
              j ||
              (v > 1 && typeof y == "string" && !T.checkClone && nr.test(y))
            )
              return e.each(function (N) {
                var O = e.eq(N);
                (j && (n[0] = y.call(this, N, O.html())), Ue(O, n, t, r));
              });
            if (
              v &&
              ((a = rt(n, e[0].ownerDocument, !1, e, r)),
              (s = a.firstChild),
              a.childNodes.length === 1 && (a = s),
              s || r)
            ) {
              for (o = i.map(ee(a, "script"), rr), u = o.length; g < v; g++)
                ((c = a),
                  g !== m &&
                    ((c = i.clone(c, !0, !0)),
                    u && i.merge(o, ee(c, "script"))),
                  t.call(e[g], c, g));
              if (u)
                for (
                  d = o[o.length - 1].ownerDocument, i.map(o, ir), g = 0;
                  g < u;
                  g++
                )
                  ((c = o[g]),
                    tt.test(c.type || "") &&
                      ...
                      (c.src && (c.type || "").toLowerCase() !== "module"
                        ...
                        : Kn(c.textContent.replace(tr, ""), c, d)));
            }
            return e;
          }
          function ot(e, n, t) {
            for (
              var r, a = n ? i.filter(n, e) : e, s = 0;
              (r = a[s]) != null;
              s++
            )
              (!t && r.nodeType === 1 && i.cleanData(ee(r)),
                r.parentNode &&
                  (t && Re(r) && yn(ee(r, "script")),
          ...
          (i.extend({
            ...
            clone: function (e, n, t) {
              ...
              if (
                ...
                for (o = ee(u), s = ee(e), r = 0, a = s.length; r < a; r++)
                  ar(s[r], o[r]);
              if (n)
                if (t)
                  for (
                    s = s || ee(e), o = o || ee(u), r = 0, a = s.length;
                    r < a;
                    r++
                  )
                    st(s[r], o[r]);
              ...
              return (
                (o = ee(u, "script")),
                o.length > 0 && yn(o, !c && ee(e, "script")),
                u
              );
            },
            cleanData: function (e) {
              for (
                var n, t, r, a = i.event.special, s = 0;
                (t = e[s]) !== void 0;
                s++
              )
                if (Je(t)) {
                  if ((n = t[k.expando])) {
                    if (n.events)
                      for (r in n.events)
                        a[r]
                          ? i.event.remove(t, r)
                          : i.removeEvent(t, r, n.handle);
                    t[k.expando] = void 0;
                  }
                  t[$.expando] && (t[$.expando] = void 0);
                }
            },
          }),
            i.fn.extend({
                ...
                return Ae(
                  ...
                  function (n) {
                    var t = this[0] || {},
                      r = 0,
                      a = this.length;
                    if (n === void 0 && t.nodeType === 1) return t.innerHTML;
                    if (
                      typeof n == "string" &&
                      !er.test(n) &&
                      !re[(nt.exec(n) || ["", ""])[1].toLowerCase()]
                    ) {
                      n = i.htmlPrefilter(n);
                      try {
                        for (; r < a; r++)
                          ((t = this[r] || {}),
                            t.nodeType === 1 &&
                              (i.cleanData(ee(t, !1)), (t.innerHTML = n)));
                        t = 0;
                      } catch {}
                    }
              ...
              replaceWith: function () {
                ...
                return Ue(
                  ...
                  function (n) {
                    ...
                    i.inArray(this, e) < 0 &&
                      (i.cleanData(ee(this)), t && t.replaceChild(n, this));
                  },
                  e,
                );
              },
            ...
            i.each(
              ...
              function (e, n) {
                i.fn[e] = function (t) {
                  for (
                    var r, a = [], s = i(t), o = s.length - 1, u = 0;
                    u <= o;
                    u++
                  )
          ...
          var xn = new RegExp("^(" + Zn + ")(?!px)[a-z%]+$", "i"),
            En = /^--/,
            cn = function (e) {
              var n = e.ownerDocument.defaultView;
              return ((!n || !n.opener) && (n = w), n.getComputedStyle(e));
            },
            lt = function (e, n, t) {
              var r,
                a,
                s = {};
              for (a in n) ((s[a] = e.style[a]), (e.style[a] = n[a]));
              r = t.call(e);
              for (a in n) e.style[a] = s[a];
              return r;
            },
            sr = new RegExp(ve.join("|"), "i");
          (function () {
            function e() {
              if (d) {
                ((c.style.cssText =
            ...
            d.style &&
              ...
              i.extend(T, {
                ...
                reliableTrDimensions: function () {
                  ...
                  return (
                    o == null &&
                      ((g = B.createElement("table")),
                      (v = B.createElement("tr")),
                      ...
                      ke.appendChild(g).appendChild(v).appendChild(m),
                      (y = w.getComputedStyle(v)),
                      (o =
          ...
          function ze(e, n, t) {
            ...
            return (
              (t = t || cn(e)),
              t &&
                ((o = t.getPropertyValue(n) || t[n]),
                u && o && (o = o.replace(Fe, "$1") || void 0),
                o === "" && !Re(e) && (o = i.style(e, n)),
                !T.pixelBoxStyles() &&
                  xn.test(o) &&
                  sr.test(n) &&
                  ((r = c.width),
          ...
          var ut = ["Webkit", "Moz", "ms"],
            pt = B.createElement("div").style,
            dt = {};
          function or(e) {
            for (var n = e[0].toUpperCase() + e.slice(1), t = ut.length; t--; )
              if (((e = ut[t] + n), e in pt)) return e;
          }
          function wn(e) {
            var n = i.cssProps[e] || dt[e];
            return n || (e in pt ? e : (dt[e] = or(e) || e));
          }
          var lr = /^(none|table(?!-c[ea]).+)/,
            cr = {
              position: "absolute",
              visibility: "hidden",
              display: "block",
          ...
          function Mn(e, n, t, r, a, s) {
            ...
            for (; o < 4; o += 2)
              (t === "margin" && (d += i.css(e, t + ve[o], !0, a)),
                r
                  ? (t === "content" &&
                      (c -= i.css(e, "padding" + ve[o], !0, a)),
                    t !== "margin" &&
                      (c -= i.css(e, "border" + ve[o] + "Width", !0, a)))
                  : ((c += i.css(e, "padding" + ve[o], !0, a)),
                    t !== "padding"
                      ? (c += i.css(e, "border" + ve[o] + "Width", !0, a))
                      : (u += i.css(e, "border" + ve[o] + "Width", !0, a))));
            return (
              !r &&
                s >= 0 &&
                (c +=
          ...
          function mt(e, n, t) {
            var r = cn(e),
              a = !T.boxSizingReliable() || t,
              s = a && i.css(e, "boxSizing", !1, r) === "border-box",
              o = s,
              u = ze(e, n, r),
              c = "offset" + n[0].toUpperCase() + n.slice(1);
            if (xn.test(u)) {
              if (!t) return u;
              u = "auto";
            }
            return (
              ((!T.boxSizingReliable() && s) ||
                (!T.reliableTrDimensions() && J(e, "tr")) ||
                u === "auto" ||
                (!parseFloat(u) && i.css(e, "display", !1, r) === "inline")) &&
                e.getClientRects().length &&
                ((s = i.css(e, "boxSizing", !1, r) === "border-box"),
                (o = c in e),
                o && (u = e[c])),
              (u = parseFloat(u) || 0),
              u + Mn(e, n, t || (s ? "border" : "content"), o, r, u) + "px"
            );
          }
          (i.extend({
            cssHooks: {
            ...
            style: function (e, n, t, r) {
              if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
                ...
                if (
                  ...
                  (s === "number" &&
                    !c &&
                    (t += (a && a[3]) || (i.cssNumber[u] ? "" : "px")),
                    !T.clearCloneStyle &&
                      t === "" &&
                      n.indexOf("background") === 0 &&
                      (d[n] = "inherit"),
                    (!o || !("set" in o) || (t = o.set(e, t, r)) !== void 0) &&
                      (c ? d.setProperty(n, t) : (d[n] = t)));
                } else
                  return o && "get" in o && (a = o.get(e, !1, r)) !== void 0
                    ? a
                    : d[n];
              }
            },
            css: function (e, n, t, r) {
              ...
              return (
                c || (n = wn(u)),
                (o = i.cssHooks[n] || i.cssHooks[u]),
                o && "get" in o && (a = o.get(e, !0, t)),
                a === void 0 && (a = ze(e, n, r)),
                a === "normal" && n in ht && (a = ht[n]),
                t === "" || t
                  ? ((s = parseFloat(a)), t === !0 || isFinite(s) ? s || 0 : a)
                  : a
              );
            },
          }),
            i.each(["height", "width"], function (e, n) {
              i.cssHooks[n] = {
                get: function (t, r, a) {
                  if (r)
                    return lr.test(i.css(t, "display")) &&
                ...
                set: function (t, r, a) {
                  var s,
                    o = cn(t),
                    u = !T.scrollboxSize() && o.position === "absolute",
                    c = u || a,
                    d = c && i.css(t, "boxSizing", !1, o) === "border-box",
                    g = a ? Mn(t, n, a, d, o) : 0;
                  return (
                    d &&
                      u &&
                    ...
                    g &&
                      (s = Ye.exec(r)) &&
                      (s[3] || "px") !== "px" &&
                      ((t.style[n] = r), (r = i.css(t, n))),
                    ft(t, r, g)
                  );
                },
              };
            }),
            (i.cssHooks.marginLeft = ct(T.reliableMarginLeft, function (e, n) {
              if (n)
                return (
                ...
                ((i.cssHooks[e + n] = {
                  expand: function (t) {
                    for (
                      ...
                      a[e + ve[r] + n] = s[r] || s[r - 2] || s[0];
                    return a;
                  },
                }),
                  e !== "margin" && (i.cssHooks[e + n].set = ft));
              },
            ),
            i.fn.extend({
              css: function (e, n) {
                return Ae(
                  ...
                  function (t, r, a) {
                    var s,
                      ...
                      c = 0;
                    if (Array.isArray(r)) {
                      for (s = cn(t), o = r.length; c < o; c++)
                        u[r[c]] = i.css(t, r[c], !1, s);
                      return u;
                    }
                    return a !== void 0 ? i.style(t, r, a) : i.css(t, r);
                  },
                  e,
                  n,
                  arguments.length > 1,
          ...
          function ne(e, n, t, r, a) {
            return new ne.prototype.init(e, n, t, r, a);
          }
          ((i.Tween = ne),
            (ne.prototype = {
              constructor: ne,
              init: function (e, n, t, r, a, s) {
                ((this.elem = e),
                  (this.prop = t),
              ...
              run: function (e) {
                ...
                return (
                  ...
                  t && t.set ? t.set(this) : ne.propHooks._default.set(this),
                  this
                );
              },
            }),
              ...
              _default: {
                ...
                set: function (e) {
                  i.fx.step[e.prop]
                    ? i.fx.step[e.prop](e)
                    : e.elem.nodeType === 1 &&
                        (i.cssHooks[e.prop] || e.elem.style[wn(e.prop)] != null)
          ...
          function kn() {
            un &&
              (B.hidden === !1 && w.requestAnimationFrame
                ? w.requestAnimationFrame(kn)
                : w.setTimeout(kn, i.fx.interval),
              i.fx.tick());
          }
          function _t() {
            return (
          ...
          function pn(e, n) {
            ...
            for (n = n ? 1 : 0; r < 4; r += 2 - n)
              ((t = ve[r]), (a["margin" + t] = a["padding" + t] = e));
            return (n && (a.opacity = a.width = e), a);
          }
          function gt(e, n, t) {
            for (
              var r,
                a = (se.tweeners[n] || []).concat(se.tweeners["*"]),
                s = 0,
                o = a.length;
              s < o;
              s++
            )
              if ((r = a[s].call(t, n, e))) return r;
          }
          function dr(e, n, t) {
            var r,
              a,
            ...
            for (r in n)
              if (((a = n[r]), ur.test(a))) {
                if (
                  ...
                  if (a === "show" && O && O[r] !== void 0) N = !0;
                  else continue;
                y[r] = (O && O[r]) || i.style(e, r);
              }
            if (((c = !i.isEmptyObject(n)), !(!c && i.isEmptyObject(y)))) {
              (v &&
                e.nodeType === 1 &&
                ((t.overflow = [j.overflow, j.overflowX, j.overflowY]),
                (d = O && O.display),
                d == null && (d = k.get(e, "display")),
                (g = i.css(e, "display")),
                g === "none" &&
                  (d
                    ? (g = d)
                    : (Pe([e], !0),
                      ...
                      (g = i.css(e, "display")),
                      Pe([e]))),
                (g === "inline" || (g === "inline-block" && d != null)) &&
                  i.css(e, "float") === "none" &&
                  (c ||
                    (m.done(function () {
                      j.display = d;
                    ...
                    d == null &&
                      ((g = j.display), (d = g === "none" ? "" : g))),
                  (j.display = "inline-block"))),
                t.overflow &&
                  ((j.overflow = "hidden"),
                  m.always(function () {
                    ((j.overflow = t.overflow[0]),
                      (j.overflowX = t.overflow[1]),
                      (j.overflowY = t.overflow[2]));
                  })),
                (c = !1));
              for (r in y)
                (c ||
                  (O
                    ...
                    : (O = k.access(e, "fxshow", { display: d })),
                  s && (O.hidden = !N),
                  N && Pe([e], !0),
                  m.done(function () {
                    (N || Pe([e]), k.remove(e, "fxshow"));
                    for (r in y) i.style(e, r, y[r]);
                  })),
                  (c = gt(N ? O[r] : 0, r, m)),
                  r in O ||
                    ((O[r] = c.start),
                    N && ((c.end = c.start), (c.start = 0))));
            }
          }
          function hr(e, n) {
            var t, r, a, s, o;
            for (t in e)
              if (
                ...
                (a = n[r]),
                (s = e[t]),
                Array.isArray(s) && ((a = s[1]), (s = e[t] = s[0])),
                t !== r && ((e[r] = s), delete e[t]),
                (o = i.cssHooks[r]),
                o && "expand" in o)
              ) {
                ((s = o.expand(s)), delete e[r]);
                for (t in s) t in e || ((e[t] = s[t]), (n[t] = a));
              } else n[r] = a;
          }
          function se(e, n, t) {
            var r,
              ...
              c = function () {
                ...
                for (
                  var v = We || _t(),
                    m = Math.max(0, d.startTime + d.duration - v),
                    y = m / d.duration || 0,
                    j = 1 - y,
                    N = 0,
                    O = d.tweens.length;
                  ...
                  d.tweens[N].run(j);
                return (
                  u.notifyWith(e, [d, j, m]),
                  j < 1 && O
                    ? m
                    : (O || u.notifyWith(e, [d, 1, 0]),
                      u.resolveWith(e, [d]),
                      !1)
                );
              },
              d = u.promise({
                ...
                createTween: function (v, m) {
                  ...
                  return (d.tweens.push(y), y);
                },
                stop: function (v) {
                  var m = 0,
                    y = v ? d.tweens.length : 0;
                  if (a) return this;
                  for (a = !0; m < y; m++) d.tweens[m].run(1);
                  return (
                    v
                      ? (u.notifyWith(e, [d, 1, 0]), u.resolveWith(e, [d, v]))
                      : u.rejectWith(e, [d, v]),
                    this
                  );
                },
              ...
              g = d.props;
            for (hr(g, d.opts.specialEasing); s < o; s++)
              if (((r = se.prefilters[s].call(d, e, g, d.opts)), r))
                return (
                  L(r.stop) &&
            ...
            return (
              ...
              i.fx.timer(
                i.extend(c, { elem: e, anim: d, queue: d.opts.queue }),
              ),
              d
            );
          }
          ((i.Animation = i.extend(se, {
            tweeners: {
              "*": [
                function (e, n) {
                  var t = this.createTween(e, n);
                  return ($n(t.elem, e, Ye.exec(n), t), t);
                },
              ],
            },
            tweener: function (e, n) {
              L(e) ? ((n = e), (e = ["*"])) : (e = e.match(le));
              for (var t, r = 0, a = e.length; r < a; r++)
                ((t = e[r]),
                  (se.tweeners[t] = se.tweeners[t] || []),
                  se.tweeners[t].unshift(n));
            },
            prefilters: [dr],
            prefilter: function (e, n) {
              n ? se.prefilters.unshift(e) : se.prefilters.push(e);
            },
          })),
            (i.speed = function (e, n, t) {
              var r =
                e && typeof e == "object"
                  ? i.extend({}, e)
                  : {
                      complete: t || (!t && n) || (L(e) && e),
                      duration: e,
                      easing: (t && n) || (n && !L(n) && n),
                    };
              return (
            ...
            i.fn.extend({
              fadeTo: function (e, n, t, r) {
                return this.filter(on)
                  ...
                  .show()
                  .end()
                  .animate({ opacity: n }, e, t, r);
              },
              animate: function (e, n, t, r) {
                var a = i.isEmptyObject(e),
                  s = i.speed(n, t, r),
                  o = function () {
                    var u = se(this, i.extend({}, e), s);
                    (a || k.get(this, "finish")) && u.stop(!0);
                  };
                return (
                  (o.finish = o),
                  a || s.queue === !1 ? this.each(o) : this.queue(s.queue, o)
                );
              },
              stop: function (e, n, t) {
                var r = function (a) {
                ...
                return (
                  typeof e != "string" && ((t = n), (n = e), (e = void 0)),
                  n && this.queue(e || "fx", []),
                  this.each(function () {
                    var a = !0,
                      ...
                      o = i.timers,
                      u = k.get(this);
                    if (s) u[s] && u[s].stop && r(u[s]);
                    else
                      for (s in u) u[s] && u[s].stop && pr.test(s) && r(u[s]);
                    for (s = o.length; s--; )
                      o[s].elem === this &&
                        (e == null || o[s].queue === e) &&
                        (o[s].anim.stop(t), (a = !1), o.splice(s, 1));
                    (a || !t) && i.dequeue(this, e);
                  })
                );
              },
              finish: function (e) {
            ...
            i.each(["toggle", "show", "hide"], function (e, n) {
              var t = i.fn[n];
              i.fn[n] = function (r, a, s) {
                return r == null || typeof r == "boolean"
                  ? t.apply(this, arguments)
                  : this.animate(pn(n, !0), r, a, s);
              };
            }),
            i.each(
              {
              ...
              function (e, n) {
                i.fn[e] = function (t, r, a) {
                  return this.animate(n, t, r, a);
                };
              },
            ),
            (i.timers = []),
            (i.fx.tick = function () {
              var e,
                n = 0,
                t = i.timers;
              for (We = Date.now(); n < t.length; n++)
                ((e = t[n]), !e() && t[n] === e && t.splice(n--, 1));
              (t.length || i.fx.stop(), (We = void 0));
            }),
            ...
            (i.fn.delay = function (e, n) {
              return (
                (e = (i.fx && i.fx.speeds[e]) || e),
                (n = n || "fx"),
                this.queue(n, function (t, r) {
                  var a = w.setTimeout(t, e);
                  r.stop = function () {
                    w.clearTimeout(a);
                  };
                })
            ...
            (function () {
              var e = B.createElement("input"),
                n = B.createElement("select"),
                t = n.appendChild(B.createElement("option"));
              ((e.type = "checkbox"),
                (T.checkOn = e.value !== ""),
                (T.optSelected = t.selected),
                (e = B.createElement("input")),
                (e.value = "t"),
                (e.type = "radio"),
                (T.radioValue = e.value === "t"));
            })());
          var At,
            Xe = i.expr.attrHandle;
          (i.fn.extend({
            attr: function (e, n) {
              return Ae(this, i.attr, e, n, arguments.length > 1);
            },
            ...
            i.extend({
              attr: function (e, n, t) {
                var r,
                  ...
                  s = e.nodeType;
                if (!(s === 3 || s === 8 || s === 2)) {
                  if (typeof e.getAttribute > "u") return i.prop(e, n, t);
                  if (
                    ((s !== 1 || !i.isXMLDoc(e)) &&
                      (a =
                        i.attrHooks[n.toLowerCase()] ||
                        (i.expr.match.bool.test(n) ? At : void 0)),
                    t !== void 0)
                  ) {
                    if (t === null) {
                      i.removeAttr(e, n);
                    ...
                    return a && "set" in a && (r = a.set(e, t, n)) !== void 0
                      ? r
                      : (e.setAttribute(n, t + ""), t);
                  }
                  return a && "get" in a && (r = a.get(e, n)) !== null
                    ? r
                    : ((r = i.find.attr(e, n)), r ?? void 0);
                }
              },
              attrHooks: {
                type: {
                  set: function (e, n) {
                    if (!T.radioValue && n === "radio" && J(e, "input")) {
                      var t = e.value;
              ...
              removeAttr: function (e, n) {
                var t,
                  ...
                  a = n && n.match(le);
                if (a && e.nodeType === 1)
                  for (; (t = a[r++]); ) e.removeAttribute(t);
              },
            }),
            (At = {
              set: function (e, n, t) {
                return (
                  n === !1 ? i.removeAttr(e, t) : e.setAttribute(t, t),
                  t
                );
              },
            }),
            i.each(i.expr.match.bool.source.match(/\w+/g), function (e, n) {
              var t = Xe[n] || i.find.attr;
              Xe[n] = function (r, a, s) {
                var o,
                  u,
                  c = a.toLowerCase();
                return (
                  s ||
                    ((u = Xe[c]),
                    (Xe[c] = o),
                    (o = t(r, a, s) != null ? c : null),
                    (Xe[c] = u)),
                  o
                );
              };
            }));
          var fr = /^(?:input|select|textarea|button)$/i,
            mr = /^(?:a|area)$/i;
          (i.fn.extend({
            prop: function (e, n) {
              return Ae(this, i.prop, e, n, arguments.length > 1);
            },
            ...
            i.extend({
              prop: function (e, n, t) {
                ...
                if (!(s === 3 || s === 8 || s === 2))
                  return (
                    (s !== 1 || !i.isXMLDoc(e)) &&
                      ((n = i.propFix[n] || n), (a = i.propHooks[n])),
                    t !== void 0
                      ? a && "set" in a && (r = a.set(e, t, n)) !== void 0
                        ? r
                        : (e[n] = t)
                      : a && "get" in a && (r = a.get(e, n)) !== null
                        ? r
                        : e[n]
                  );
              },
              propHooks: {
                tabIndex: {
                  get: function (e) {
                    ...
                    return n
                      ? parseInt(n, 10)
                      : fr.test(e.nodeName) || (mr.test(e.nodeName) && e.href)
                        ? 0
                        : -1;
                  },
                },
            ...
            T.optSelected ||
              (i.propHooks.selected = {
                get: function (e) {
                  var n = e.parentNode;
                  return (
                    n && n.parentNode && n.parentNode.selectedIndex,
                    null
                  );
                },
                set: function (e) {
          ...
          i.fn.extend({
            addClass: function (e) {
              ...
              return L(e)
                ? this.each(function (u) {
                    i(this).addClass(e.call(this, u, Se(this)));
                  })
                : ((n = Cn(e)),
                  n.length
                    ? this.each(function () {
            ...
            removeClass: function (e) {
              ...
              return L(e)
                ? this.each(function (u) {
                    i(this).removeClass(e.call(this, u, Se(this)));
                  })
                : arguments.length
                  ? ((n = Cn(e)),
                    n.length
            ...
            toggleClass: function (e, n) {
              var t,
                ...
                s,
                o = typeof e,
                u = o === "string" || Array.isArray(e);
              return L(e)
                ? this.each(function (c) {
                    i(this).toggleClass(e.call(this, c, Se(this), n), n);
                  })
                : typeof n == "boolean" && u
                  ? n
                    ? this.addClass(e)
                  ...
                  : ((t = Cn(e)),
                    this.each(function () {
                      if (u)
                        for (s = i(this), a = 0; a < t.length; a++)
                          ((r = t[a]),
                            s.hasClass(r) ? s.removeClass(r) : s.addClass(r));
                      else
                        (e === void 0 || o === "boolean") &&
                          ((r = Se(this)),
                          r && k.set(this, "__className__", r),
                          this.setAttribute &&
                            this.setAttribute(
                              "class",
                              r || e === !1
            ...
            hasClass: function (e) {
              var n,
                ...
                r = 0;
              for (n = " " + e + " "; (t = this[r++]); )
                if (t.nodeType === 1 && (" " + Ce(Se(t)) + " ").indexOf(n) > -1)
                  return !0;
              return !1;
            },
          });
                ...
                ? ((r = L(e)),
                  this.each(function (s) {
                    ...
                    this.nodeType === 1 &&
                      ...
                      (!n ||
                        !("set" in n) ||
                        n.set(this, o, "value") === void 0) &&
                        (this.value = o));
                  }))
                : a
                  ? ((n =
                      i.valHooks[a.type] ||
                      i.valHooks[a.nodeName.toLowerCase()]),
                    n && "get" in n && (t = n.get(a, "value")) !== void 0
                      ? t
                      : ((t = a.value),
                        typeof t == "string" ? t.replace(_r, "") : (t ?? "")))
                  : void 0;
            },
          }),
            i.extend({
                ...
                select: {
                  get: function (e) {
                    var n,
                      ...
                      u = o ? null : [],
                      c = o ? s + 1 : a.length;
                    for (s < 0 ? (r = c) : (r = o ? s : 0); r < c; r++)
                      if (
                        ((t = a[r]),
                        (t.selected || r === s) &&
                          !t.disabled &&
                          (!t.parentNode.disabled ||
                            !J(t.parentNode, "optgroup")))
                      ) {
                        if (((n = i(t).val()), o)) return n;
                        u.push(n);
                      }
                    return u;
                  },
                  set: function (e, n) {
                    for (
                      var t, r, a = e.options, s = i.makeArray(n), o = a.length;
                      o--;
                    )
                      ((r = a[o]),
                        (r.selected =
                          i.inArray(i.valHooks.option.get(r), s) > -1) &&
                          (t = !0));
                    return (t || (e.selectedIndex = -1), s);
                  },
                },
              },
            }),
          ...
          i.parseXML = function (e) {
            ...
            try {
              n = new w.DOMParser().parseFromString(e, "text/xml");
            } catch {}
            return (
              (t = n && n.getElementsByTagName("parsererror")[0]),
              (!n || t) &&
                i.error(
                  "Invalid XML: " +
                    (t
                      ? i.map(t.childNodes, function (r) {
...
`)
          ...
          (i.extend(i.event, {
            trigger: function (e, n, t, r) {
              var a,
                ...
                v,
                m = [t || B],
                y = He.call(e, "type") ? e.type : e,
                j = He.call(e, "namespace") ? e.namespace.split(".") : [];
              if (
                ((s = v = o = t = t || B),
                !(t.nodeType === 3 || t.nodeType === 8) &&
                  !yt.test(y + i.event.triggered) &&
                  (y.indexOf(".") > -1 &&
                    ((j = y.split(".")), (y = j.shift()), j.sort()),
                  (c = y.indexOf(":") < 0 && "on" + y),
                  (e = e[i.expando]
                    ? e
                    : new i.Event(y, typeof e == "object" && e)),
                  (e.isTrigger = r ? 2 : 3),
                  (e.namespace = j.join(".")),
                  ...
                  (e.result = void 0),
                  e.target || (e.target = t),
                  (n = n == null ? [e] : i.makeArray(n, [e])),
                  (g = i.event.special[y] || {}),
                  !(!r && g.trigger && g.trigger.apply(t, n) === !1)))
              ) {
                if (!r && !g.noBubble && !Be(t)) {
                  for (
                    u = g.delegateType || y,
                      yt.test(u + y) || (s = s.parentNode);
                    s;
                    s = s.parentNode
                  )
                    (m.push(s), (o = s));
                  o === (t.ownerDocument || B) &&
                    m.push(o.defaultView || o.parentWindow || w);
                }
                for (a = 0; (s = m[a++]) && !e.isPropagationStopped(); )
                  ((v = s),
                    (e.type = a > 1 ? u : g.bindType || y),
                    (d =
                    ...
                    d &&
                      d.apply &&
                      Je(s) &&
                      ((e.result = d.apply(s, n)),
                      e.result === !1 && e.preventDefault()));
                return (
                  (e.type = y),
                  !r &&
                    !e.isDefaultPrevented() &&
                    (!g._default || g._default.apply(m.pop(), n) === !1) &&
                    Je(t) &&
                    c &&
                    L(t[y]) &&
                    !Be(t) &&
                    ...
                    o && (t[c] = null),
                    (i.event.triggered = y),
                    e.isPropagationStopped() && v.addEventListener(y, bt),
                    t[y](),
                    e.isPropagationStopped() && v.removeEventListener(y, bt),
            ...
            simulate: function (e, n, t) {
              var r = i.extend(new i.Event(), t, { type: e, isSimulated: !0 });
            ...
            i.fn.extend({
              ...
              triggerHandler: function (e, n) {
                var t = this[0];
                if (t) return i.event.trigger(e, n, t, !0);
              },
            }));
          var gr = /\[\]$/,
            xt = /\r?\n/g,
          ...
          function jn(e, n, t, r) {
            ...
            else if (!t && Te(n) === "object")
              for (a in n) jn(e + "[" + a + "]", n[a], t, r);
            else r(e, n);
          }
          ((i.param = function (e, n) {
            var t,
              ...
              a = function (s, o) {
                var u = L(o) ? o() : o;
                r[r.length] =
                  encodeURIComponent(s) + "=" + encodeURIComponent(u ?? "");
              };
            if (e == null) return "";
...
`,
          ...
          function Mt(e) {
            return function (n, t) {
              ...
              var r,
                a = 0,
                s = n.toLowerCase().match(le) || [];
              if (L(t))
                for (; (r = s[a++]); )
                  r[0] === "+"
                    ? ((r = r.slice(1) || "*"), (e[r] = e[r] || []).unshift(t))
                    : (e[r] = e[r] || []).push(t);
            };
          }
          function kt(e, n, t, r) {
            ...
            function o(u) {
              ...
              return (
                (a[u] = !0),
                i.each(e[u] || [], function (d, g) {
                  var v = g(n, t, r);
                  if (typeof v == "string" && !s && !a[v])
                    return (n.dataTypes.unshift(v), o(v), !1);
                  if (s) return !(c = v);
                }),
                c
              );
          ...
          function Bn(e, n) {
            ...
            for (t in n)
              n[t] !== void 0 && ((a[t] ? e : r || (r = {}))[t] = n[t]);
            return (r && i.extend(!0, e, r), e);
          }
          function Cr(e, n, t) {
            for (
              var r, a, s, o, u = e.contents, c = e.dataTypes;
              c[0] === "*";
            )
              (c.shift(),
                r === void 0 &&
            ...
            if (s) return (s !== c[0] && c.unshift(s), t[s]);
          }
          function Sr(e, n, t, r) {
            var a,
              s,
            ...
            for (s = g.shift(); s; )
              if (
                (e.responseFields[s] && (t[e.responseFields[s]] = n),
                !c && r && e.dataFilter && (n = e.dataFilter(n, e.dataType)),
                (c = s),
                (s = g.shift()),
                s)
              ) {
                  ...
                  if (o !== !0)
                    if (o && e.throws) n = o(n);
                      ...
                      try {
                        ...
                        return {
                          state: "parsererror",
                          error: o ? v : "No conversion from " + c + " to " + s,
                        };
                      }
                }
              }
          ...
          (i.extend({
            ...
            ajaxSetup: function (e, n) {
              return n ? Bn(Bn(e, i.ajaxSettings), n) : Bn(i.ajaxSettings, e);
            },
            ajaxPrefilter: Mt(Et),
            ajaxTransport: Mt(Dn),
            ajax: function (e, n) {
              ...
              var t,
                ...
                m = i.ajaxSetup({}, n),
                y = m.context || m,
                j = m.context && (y.nodeType || y.jquery) ? i(y) : i.event,
                N = i.Deferred(),
                ...
                q = {
                  ...
                  setRequestHeader: function (U, Y) {
                    return (
                      c == null &&
                        ((U = ue[U.toLowerCase()] = ue[U.toLowerCase()] || U),
                        (G[U] = Y)),
                      this
                    );
                  },
                  overrideMimeType: function (U) {
                    return (c == null && (m.mimeType = U), this);
                  },
                  statusCode: function (U) {
                    var Y;
                    if (U)
                      if (c) q.always(U[q.status]);
                      else for (Y in U) z[Y] = [z[Y], U[Y]];
                    return this;
                  },
                  abort: function (U) {
                    var Y = U || pe;
                    return (t && t.abort(Y), je(0, Y), this);
                  },
                };
              if (
                (N.promise(q),
                (m.url = ((e || m.url || Ze.href) + "").replace(
                  kr,
                  Ze.protocol + "//",
                )),
              ...
              if (
                (m.data &&
                  ...
                  (m.data = i.param(m.data, m.traditional)),
                kt(Et, m, n, q),
                c)
              )
                return q;
              ((d = i.event && m.global),
                ...
                m.hasContent
                  ? m.data &&
                    ...
                    (m.data = m.data.replace(yr, "+"))
                  : ((v = m.url.slice(r.length)),
                    m.data &&
                      (m.processData || typeof m.data == "string") &&
                      ((r += (Sn.test(r) ? "&" : "?") + m.data), delete m.data),
                    m.cache === !1 &&
                      ((r = r.replace(xr, "$1")),
                      (v = (Sn.test(r) ? "&" : "?") + "_=" + vt.guid++ + v)),
                    (m.url = r + v)),
                m.ifModified &&
                  (i.lastModified[r] &&
              ...
              for (g in m.headers) q.setRequestHeader(g, m.headers[g]);
              if (m.beforeSend && (m.beforeSend.call(y, q, m) === !1 || c))
                return q.abort();
              if (
                ((pe = "abort"),
                O.add(m.complete),
                ...
                if (((q.readyState = 1), d && j.trigger("ajaxSend", [q, m]), c))
                  return q;
                m.async &&
                  m.timeout > 0 &&
              ...
              function je(U, Y, en, Ln) {
                ...
                c ||
                  ...
                  (t = void 0),
                  (a = Ln || ""),
                  (q.readyState = U > 0 ? 4 : 0),
                  (de = (U >= 200 && U < 300) || U === 304),
                  en && (Ee = Cr(m, q, en)),
                  !de &&
                    i.inArray("script", m.dataTypes) > -1 &&
                    i.inArray("json", m.dataTypes) < 0 &&
                    (m.converters["text script"] = function () {}),
                  (Ee = Sr(m, Ee, q, de)),
                  de
                    ? (m.ifModified &&
                        ((we = q.getResponseHeader("Last-Modified")),
                        we && (i.lastModified[r] = we),
                        (we = q.getResponseHeader("etag")),
                        we && (i.etag[r] = we)),
                      U === 204 || m.type === "HEAD"
                        ? (ie = "nocontent")
                        : U === 304
                          ...
                          : ((ie = Ee.state),
                            ...
                            (de = !he)))
                    : ((he = ie),
                      (U || !ie) && ((ie = "error"), U < 0 && (U = 0))),
                  (q.status = U),
                  (q.statusText = (Y || ie) + ""),
                  de
                    ? N.resolveWith(y, [nn, ie, q])
                    : N.rejectWith(y, [q, ie, he]),
                  q.statusCode(z),
                  (z = void 0),
                  d &&
                    j.trigger(de ? "ajaxSuccess" : "ajaxError", [
                      q,
                      m,
                      de ? nn : he,
                    ]),
                  O.fireWith(y, [q, ie]),
                  d &&
                    (j.trigger("ajaxComplete", [q, m]),
                    --i.active || i.event.trigger("ajaxStop")));
              }
              return q;
            },
            getJSON: function (e, n, t) {
              return i.get(e, n, t, "json");
            },
            ...
            i.each(["get", "post"], function (e, n) {
              i[n] = function (t, r, a, s) {
                return (
                  L(r) && ((s = s || a), (a = r), (r = void 0)),
                  i.ajax(
                    i.extend(
                      { url: t, type: n, dataType: s, data: r, success: a },
                      i.isPlainObject(t) && t,
                    ),
                  )
                );
            ...
            i.fn.extend({
              wrapAll: function (e) {
                ...
                return (
                  this[0] &&
                    (L(e) && (e = e.call(this[0])),
                    (n = i(e, this[0].ownerDocument).eq(0).clone(!0)),
              ...
              wrap: function (e) {
                ...
                return this.each(function (t) {
                  i(this).wrapAll(n ? e.call(this, t) : e);
                });
              },
              unwrap: function (e) {
                return (
          ...
          var jr = { 0: 200, 1223: 204 },
            $e = i.ajaxSettings.xhr();
          ((T.cors = !!$e && "withCredentials" in $e),
            (T.ajax = $e = !!$e),
            i.ajaxTransport(function (e) {
              var n, t;
              if (T.cors || ($e && !e.crossDomain))
                return {
                  send: function (r, a) {
                    var s,
                      o = e.xhr();
                    ...
                    ((n = function (u) {
                        ...
                        n &&
                          ...
                          u === "abort"
                            ...
                            : u === "error"
                              ...
                              : a(
                                  jr[o.status] || o.status,
                                  o.statusText,
                                  (o.responseType || "text") !== "text" ||
                      ...
                      (o.onload = n()),
                      (t = o.onerror = o.ontimeout = n("error")),
                      o.onabort !== void 0
                        ? (o.onabort = t)
                    ...
                    ((n = i("<script>")
                      ...
                      .on(
                        ...
                        (t = function (s) {
                          (n.remove(),
                            (t = null),
                            s && a(s.type === "error" ? 404 : 200, s.type));
                        }),
                      )),
          ...
          (i.ajaxSetup({
            ...
            jsonpCallback: function () {
              var e = Ct.pop() || i.expando + "_" + vt.guid++;
              return ((this[e] = !0), e);
            },
          }),
            i.ajaxPrefilter("json jsonp", function (e, n, t) {
              var r,
                a,
                s,
                o =
              ...
              if (o || e.dataTypes[0] === "jsonp")
                return (
                  ...
                  o
                    ? (e[o] = e[o].replace(Tn, "$1" + r))
                    : e.jsonp !== !1 &&
                      (e.url +=
                        (Sn.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
                  ...
                  t.always(function () {
                    (a === void 0 ? i(w).removeProp(r) : (w[r] = a),
            ...
            (i.parseHTML = function (e, n, t) {
              if (typeof e != "string") return [];
              typeof n == "boolean" && ((t = n), (n = !1));
              var r, a, s;
              return (
                n ||
                  (T.createHTMLDocument
                    ? ((n = B.implementation.createHTMLDocument("")),
            ...
            (i.fn.load = function (e, n, t) {
              var r,
                ...
                u = e.indexOf(" ");
              return (
                u > -1 && ((r = Ce(e.slice(u))), (e = e.slice(0, u))),
                L(n)
                  ? ((t = n), (n = void 0))
                ...
                o.length > 0 &&
                  i
                    ...
                    .done(function (c) {
                      ((s = arguments),
                        o.html(
                          r ? i("<div>").append(i.parseHTML(c)).find(r) : c,
                        ));
                    })
                    .always(
                      t &&
                        function (c, d) {
                          o.each(function () {
                            t.apply(this, s || [c.responseText, d, c]);
                          });
                        },
                    ),
                this
            ...
            (i.offset = {
              setOffset: function (e, n, t) {
                var r,
                  ...
                  v = i(e),
                  m = {};
                (g === "static" && (e.style.position = "relative"),
                  (u = v.offset()),
                  (s = i.css(e, "top")),
                  (c = i.css(e, "left")),
                  (d =
                    ...
                    (s + c).indexOf("auto") > -1),
                  d
                    ? ((r = v.position()), (o = r.top), (a = r.left))
                    : ((o = parseFloat(s) || 0), (a = parseFloat(c) || 0)),
                  L(n) && (n = n.call(e, t, i.extend({}, u))),
                  n.top != null && (m.top = n.top - u.top + o),
                  n.left != null && (m.left = n.left - u.left + a),
                  "using" in n ? n.using.call(e, m) : v.css(m));
              },
            }),
            i.fn.extend({
              offset: function (e) {
                ...
                if (this[0]) {
                  ...
                  if (i.css(r, "position") === "fixed")
                    ...
                    for (
                      n = this.offset(),
                        t = r.ownerDocument,
                        e = r.offsetParent || t.documentElement;
                      e &&
                  ...
                  return {
                    top: n.top - a.top - i.css(r, "marginTop", !0),
                    left: n.left - a.left - i.css(r, "marginLeft", !0),
                  };
                }
              },
            ...
            i.each(["top", "left"], function (e, n) {
              i.cssHooks[n] = ct(T.pixelPosition, function (t, r) {
                if (r)
                  return (
                    (r = ze(t, n)),
                    xn.test(r) ? i(t).position()[n] + "px" : r
                  );
              });
            }),
            i.each({ Height: "height", Width: "width" }, function (e, n) {
              i.each(
                ...
                function (t, r) {
                  i.fn[r] = function (a, s) {
                    var o = arguments.length && (t || typeof a != "boolean"),
                      u = t || (a === !0 || s === !0 ? "margin" : "border");
                    return Ae(
                      this,
                      function (c, d, g) {
                        var v;
          ...
          ((i.proxy = function (e, n) {
            var t, r, a;
            if (
              (typeof n == "string" && ((t = e[n]), (n = e), (e = t)), !!L(e))
            )
              return (
          ...
          return (
            (i.noConflict = function (e) {
              return (
                w.$ === i && (w.$ = Br),
                e && w.jQuery === i && (w.jQuery = Ir),
                i
              );
            }),
            typeof H > "u" && (w.jQuery = w.$ = i),
            i
          );
        });
      })(jquery$1)),
  ...
  return (
    hasRequiredDist ||
      ...
      (function (module, exports) {
        (function (w, H) {
          module.exports = H(requireJquery(), requireReact());
        })(
          self,
          function (
...
//# sourceURL=webpack://@react-jvectormap/core/data:image/gif;base64,?`);
                  ...
                  jquery: (I) => {
                    I.exports = __WEBPACK_EXTERNAL_MODULE_jquery__;
                  },
                  react: (I) => {
                    I.exports = __WEBPACK_EXTERNAL_MODULE_react__;
                  },
                },
                __webpack_module_cache__ = {};
              function __webpack_require__(I) {
                var w = __webpack_module_cache__[I];
                if (w !== void 0) return w.exports;
                var H = (__webpack_module_cache__[I] = { id: I, exports: {} });
                return (
                  __webpack_modules__[I](H, H.exports, __webpack_require__),
                  H.exports
                );
              }
              ((__webpack_require__.m = __webpack_modules__),
                (__webpack_require__.n = (I) => {
                  var w = I && I.__esModule ? () => I.default : () => I;
                  return (__webpack_require__.d(w, { a: w }), w);
                }),
                (__webpack_require__.d = (I, w) => {
                  for (var H in w)
                    __webpack_require__.o(w, H) &&
                      !__webpack_require__.o(I, H) &&
                      Object.defineProperty(I, H, {
                        enumerable: !0,
                        get: w[H],
                      });
                }),
                (__webpack_require__.o = (I, w) =>
...
function Home() {
  return jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
    children: [
      jsxRuntimeExports.jsx(PageMeta, {
        title:
          "React.js Ecommerce Dashboard | TailAdmin - React.js Admin Dashboard Template",
        description:
          "This is React.js Ecommerce Dashboard page for TailAdmin - React.js Tailwind CSS Admin Dashboard Template",
      }),
      jsxRuntimeExports.jsxs("div", {
        ...
        children: [
          jsxRuntimeExports.jsxs("div", {
            ...
            children: [
              jsxRuntimeExports.jsx(EcommerceMetrics, {}),
              jsxRuntimeExports.jsx(MonthlySalesChart, {}),
            ],
          }),
          jsxRuntimeExports.jsx("div", {
            className: "col-span-12 xl:col-span-5",
            children: jsxRuntimeExports.jsx(MonthlyTarget, {}),
          }),
          jsxRuntimeExports.jsx("div", {
            className: "col-span-12",
            children: jsxRuntimeExports.jsx(StatisticsChart, {}),
          }),
        ],
      }),
    ],
